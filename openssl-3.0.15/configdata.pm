...
unless (caller) {
    ...
    use lib '/workspace/openssl-3.0.15/util/perl';
    use OpenSSL::fallback '/workspace/openssl-3.0.15/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/workspace/openssl-3.0.15/Configurations';
        use gentemplate;
